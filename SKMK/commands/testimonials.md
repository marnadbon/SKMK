...
- **Bestaat het niet** → start het 4-fasen gesprek: eigen klantreviews → marketplace reviews → concurrent-sites → online communities

Sla het eindresultaat op naar `${CLAUDE_PLUGIN_DATA}/references/testimonials.md`.
