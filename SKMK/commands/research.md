...
- **Bestaat het niet** → start het 7-fasen gesprek voor markt- en productonderzoek vanaf Fase 1

Sla het eindresultaat op naar `${CLAUDE_PLUGIN_DATA}/references/research.md`.
